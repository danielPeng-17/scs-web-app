...
import { List, AspectRatio, Typography, Sheet, styled, Grid, Box } from '@mui/joy';
                ...
                <Grid md={6}>
                    <Item>
                        <div className="productInfo" style={{paddingTop: '1em'}}>
                            <Typography level="h3" sx={{ paddingBottom: '0.5em'}}>{item.name}</Typography>
                            <Typography level="body1">{item.description}</Typography>
                            <Typography level="body2">Brand: {item.brand}</Typography>
                            <Typography level="body2">Seller: {item.seller}</Typography>
